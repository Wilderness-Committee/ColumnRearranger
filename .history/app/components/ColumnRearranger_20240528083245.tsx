...
./app/components/ColumnRearranger.tsx
Error: 
  ...
  | 
  | 
   ,-[/Users/beauxwalton/ReorderTool/reorder-tool/app/components/ColumnRearranger.tsx:1:1]
 1 | import React, { useState } from "react";
   :                 ^^^^^^^^
 2 | import Papa from "papaparse";
 3 | 
 4 | const ColumnRearranger = () => {
   `----
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      <div className="bg-white shadow-md rounded p-6 w-full max-w-lg">
        <h2 className="text-2xl font-semibold mb-4">Column Rearranger Tool</h2>
        <input
          type="file"
          accept=".csv"
